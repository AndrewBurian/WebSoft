...
!function(e) {
    ...
    t.prototype = {constructor: t, replaceSelect: function() {
            ...
            for (r = 0; r < i.length; r++)
                i[r].nodeName != "type" && i[r].nodeName != "name" && i[r].nodeName != "id" && i[r].nodeName != "data-provide" && !i[r].nodeName.match(/^on/) && this.$element.attr(i[r].nodeName, i[r].nodeValue);
            ...
            var t = {}, n;
            for (n in e)
                e[n].toLowerCase().indexOf(this.query.toLowerCase()) || (t[n] = e[n], delete e[n]);
            for (n in e)
                ~e[n].indexOf(this.query) && (t[n] = e[n], delete e[n]);
            for (n in e)
                t[n] = e[n];
            return t
