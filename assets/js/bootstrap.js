...
!function($) {
    ...
    var Typeahead = function(element, options) {
        ...
        if (typeof this.$target != 'undefined')
            this.$element.attr('data-value', this.$target.val())
        else if (typeof this.$element.attr('data-value') == 'undefined')
            this.$element.attr('data-value', this.strict ? '' : this.value)
    ...
    Typeahead.prototype = {
        ...
        , replaceSelect: function() {
            ...
            for (var i = 0; i < options.length; i++) {
                ...
                if (this.$target.val() == $option.val())
                    this.$element.val($option.html())
            }
            ...
            if (this.$target.attr('autofocus'))
                this.$element.trigger('focus').select()
        ...
        , render: function(items) {
            ...
            $.map(items, function(item, value) {
                if (list.length >= that.options.items)
                    return
 ...
 * ===========================================================
 * Copyright 2013 Jasny BV, Netherlands.
 *
 * Licensed under the Apache License, Version 2.0 (the "License")
 * you may not use this file except in compliance with the License.
 * You may obtain a copy of the License at
...
!function($) {
    ...
    $.fn.rowlink = function(options) {
        return this.each(function() {
            ...
            if (!data)
                $this.data('rowlink', (data = new Rowlink(this, options)))
        })
    }
